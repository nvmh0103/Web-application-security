...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    (props, ref) => {
        ...
        const rootClassName = cn(
            {
                "pl-2 w-300 flex-initial h-12 min-w-0 relative bg-white border-gray-500 border text-black hover:drop-shadow-xl rounded-40 items-center hover:shadow-cart transition duration-150": variant === "jl",
            },

            {
                "inline flex cursor bg-white rounded-40 text-black hover:drop-shadow-xl hover:shadow-cart  ":
                    variant === "flat",
                "h-11 md:h-12 px-5 bg-heading text-white py-2 transform-none normal-case hover:text-white hover:drop-shadow-xl hover:shadow-cart":
                    variant === "slim",
                // "step-form-button-submit": variant === "flat",
